...
const debug = _debug('penpress:config')
...
const resolve = (root: string, file: string) => normalizePath(path.resolve(root, `.penpress`, file))
...
export async function resolveConfig(
  ...
  const config: SiteConfig = {
    ...
    outDir,
    cacheDir,
    tempDir: resolve(process.cwd(), '../node_modules/.penpress/temp'),
...
export async function resolveSiteData(
  ...
  return {
    ...
    rss: userConfig.rss,
    title: userConfig.title || 'PenPress',
    titleTemplate: userConfig.titleTemplate,
    description: userConfig.description || 'A PenPress site',
