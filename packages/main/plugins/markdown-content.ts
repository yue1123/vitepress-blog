...
import { appendFrontmatter, getFileCreateTime, getFileUpdateTime, getSnippets, escapeVueInCode } from '../utils'
import { mermaidCodeContainerReg, plantUmlCodeContainerReg, frontmatterReg } from '../constants'

export default function MarkdownContent(userConfigResolver: () => Config): Plugin {
